 ...
 var arr2 = ["artistic" , "capture" , "sensational" , "spacious" , "discriminate" , "unconcious" , "commute" , "occasional" , "delicate" , "courageous" , "phenomenon" , "presently" , "recharge"];

var data1 = {                                          
 "questions": ["artistic","greiling","capture","fructionest","sensational","spacious","discriminate","unconcious","protominant","commute","occasional","delicate","courageous","hibital","phenomenon","rediction","presently","recharge"]
},
...
if(arr2.length!=(arr2.length - final.length) || arr2.length!=values.length){
  message001.innerHTML = "<text style= color:red >You Are Lost! Try Again.</text>" ;
                disappear001.innerHTML = "<button onclick=window.alert(arr2)>Need Help? 🛈</button>";
                wrongs.play();
                reload1.innerHTML = "<div id=center001><button class=button001 onclick=reload()>Try Again</button></div>";
