 ...
 var arr2 = ["promotion" , "cumbersome" , "predictable" , "evoke" , "migrate" , "repeat" , "oblivious" , "cumulative" , "foreigner" , "advocate" , "accumulate" , "collection"];

var data1 = {                                          
 "questions": ["promotion","besition","cumbersome","predictable","inhypothe","evoke","migrate","repeat","behotive","oblivious","cumulative","foreigner","advocate","etherable","inselectful","accumulate","misbuke","collection"]
},
