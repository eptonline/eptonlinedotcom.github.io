...
{ 
        ...
        "source" : " I use public transport to travel. So that means I have to get up early to catch the bus. I prefer using an AC bus as the route to my work is quite long and the hot weather becomes quite intolerable. It doesn’t accommodate more passengers than it’s supposed to, which is quite rare for most public buses in the country. And since I have the privilege to afford a fairly developed public transport, I choose to use this bus for my own safety."
},
