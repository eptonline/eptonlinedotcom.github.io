...
function submit001() {
  clearInterval(timer);
            ...
            if (d22 == "lief") {
                i22 = 1;
                input016.value = d22;
                check016.innerHTML = "<text class=button002>" + "✔" + "</text>";
            } else {
                input016.value = d22;
                check016.innerHTML = "<text class=button002>" + "✖" + "</text>";
            }
            ...
            if (e22 == "ars") {
                j22 = 1;
                input017.value = e22;
                check017.innerHTML = "<text class=button002>" + "✔" + "</text>";
            } else {
                input017.value = e22;
                check017.innerHTML = "<text class=button002>" + "✖" + "</text>";
            }
            ...
            if (f22 == "fect") {
                k22 = 1;
                input018.value = f22;
                check018.innerHTML = "<text class=button002>" + "✔" + "</text>";
            } else {
                input018.value = f22;
                check018.innerHTML = "<text class=button002>" + "✖" + "</text>";
            }
            ...
            if (g == 1 && h == 1 && i == 1 && j == 1 && k == 1 && g1 == 1 && h1 == 1 && i1 == 1 && j1 == 1 && k1 == 1 && g2 == 1 && h2 == 1 && i2 == 1 && j2 == 1 && k2 == 1 && i22 == 1 && j22 == 1 && k22 == 1) {
